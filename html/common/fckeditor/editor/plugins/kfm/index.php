...
$kfm_session->set('kfm_url',dirname((!empty($_SERVER['HTTPS'])) ? "https:
...
while (false!==($plugin=readdir($h))) {
    ...
    <body>
        <div id="removeme">
            ...
            <noscript>KFM relies on JavaScript. Please either turn on JavaScript in your browser, or <a href="http:
        </div>
<?php
$templated = 0;
