...
define("_INSTALL_L6","Existuje jistý rozdíl mezi Vaším nastavením XOOPS_ROOT_PATH na øádce 31 v souboru mainfile.php a tím, co detekoval instalaèní program.");
define("_INSTALL_L7","Vaše nastavení: ");
define("_INSTALL_L8","Instalaèní program detekoval: ");
define("_INSTALL_L9","(Na platformách Microsoft se obèas stává, že získáte toto chybové oznámení, aèkoliv Vaše nastavení je správné. Pokud je to tento pøípad, prosíme, pokraèujte stiknutím tlaèítka Další)");
define("_INSTALL_L10","Prosíme, stisknìte tlaèítko níže pokud je toto opravdu v poøádku.");
...
define("_INSTALL_L17","%s je uživatelské jméno pro pøístup do databáze.");
...
define("_INSTALL_L66","Vyberte databázi, kterou chcete pro Xoops Cube použít.");
...
define("_INSTALL_L65","Vaše uživatelské jméno pro pøístup na databázový server do databáze.");
...
define("_INSTALL_L68","Vaše heslo pro pøístup na databázový server do databáze.");
define("_INSTALL_L30","Oznaèení tabulek");
define("_INSTALL_L63","Pøedpona (prefix) tabulek kvùli zamezení konfliktù pøi vytváøení tabulek pro Xoops Cube. Pokud si nejste jisti, prosté 'xoops' by mìlo fungovat bez potíží.");
...
define("_INSTALL_L35","Pokud jste narazili na nìjaké chyby, prosíme, oznamte to vývojovému týmu na <a href='http:
...
define("_INSTALL_L46","Kvùli provtnímu nastavení modulù obsažených v systému XOOPS Cube musejí být následující soubory nastaveny pro zápis serverem. Je nezbytné, aby bìhem instalace byl soubor mainfile.php nastaven pro zápis serverem (napø. chmod 777 mainfile.php na UNIX/LINUX serveru nebo na Windowsech nastavte soubor mainfile.php tak, aby nebyl nastaven \"Pouze pro ètení\"). Až to udìláte znovunaètìte tuto stránku.");
define("_INSTALL_L47","Další");
define("_INSTALL_L53","Prosím, potvrïte tyto vložené údaje:");
define("_INSTALL_L60","Nepodaøilo se zapsat data do souboru mainfile.php. Prosíme, pøekontrolujte pøístupová práva, pøíp. nastavení \"Pouze pro ètení\", a zkuste znovu data uložit.");
define("_INSTALL_L61","Nepodaøilo se zapsat data do souboru mainfile.php. Kontaktujte administrátora serveru pro další pomoc.");
define("_INSTALL_L62","Nastavení bylo v poøádku uloženo do souboru mainfile.php.");
define("_INSTALL_L72","Následující adresáøe musejí být vytvoøeny s právem zápisu serverem. (napø. 'chmod 777 jmeno_adresare' na UNIX/LINUX serveru)");
define("_INSTALL_L73","Chybný email");
define("_INSTALL_L80","úvod");
define("_INSTALL_L81","provìøení pøístupových práv");
define("_INSTALL_L82","Provìøení pøístupových práv k souborùm a adresáøùm..");
...
define("_INSTALL_L87","Žádné problémy nebyly zjištìny.");
...
define("_INSTALL_L96","Je urèitý konfikt mezi detekovanou fyzickou cestou (%s) a tou, kterou jste zadali.");
define("_INSTALL_L97","<b>Fyzická cesta</b> je v poøádku.");
define("_INSTALL_L99","<b>Fyzická cesta</b> musí být adresáø.");
...
define("_INSTALL_L106","Nepodaøilo se pøipojit na databázový server.");
define("_INSTALL_L107","Prosíme, zkontrolujte databázový server a jeho nastavení.");
define("_INSTALL_L108","Spojení na databázový server je v poøádku.");
...
define("_INSTALL_L119","%d øádkù vloženo do tabulky %s.");
define("_INSTALL_L120","Nepodaøilo se vložit %d øádkù do tabulky %s.");
define("_INSTALL_L121","Promìnná %s uložena jako %s.");
define("_INSTALL_L122","Nepodaøilo se uložit promìnnou %s.");
define("_INSTALL_L123","Soubor %s uložen do adresáøe cache/.");
define("_INSTALL_L124","Nepodaøilo se uložit soubor %s do adresáøe cache/.");
...
define("_INSTALL_L131","Tabulky pro XOOPS Cube již ve Vaší databázi existují.");
...
define("_INSTALL_L141","Instalaèní program nyní pøevede všechny moduly, aby fungovaly v systému XOOPS Cube.<br />Ujistìte se, že jste na server nahráli všechna data z balíku XOOPS Cube.<br />Je možné, že to chvilku potrvá.");
...
define("_INSTALL_L145","Komentáø (ID: %s) vložen do databáze.");
define("_INSTALL_L146","Nepodaèilo se vložit komentáø (ID: %s) do databáze.");
define("_INSTALL_L147","Adaptování komentáøù..");
define("_INSTALL_L148","Pøevod dokonèen.");
define("_INSTALL_L149","Instalaèní program nyní pøevede komentáøe z XOOPS 1.3.x do nového XOOPS Cube.<br />Je možné, že to chvilku potrvá.");
define("_INSTALL_L150","Instalaèní program nyní pøevede emotikony a uživatelská zaøazení do nového XOOPS Cube.<br />Je možné, že to chvilku potrvá.");
define("_INSTALL_L151","Instalaèní program nyní pøevede ikony do nového XOOPS Cube.<br />Je možné, že to chvilku potrvá.");
define("_INSTALL_L155","Pøevod emotikonù/obrázkù uživatelských zaøazení..");
define("_INSTALL_L156","Pøevod uživatelských ikon..");
...
define('_INSTALL_L128', 'Vyberte si jazyk pro použití bìhem instalace');
define('_INSTALL_L200', 'Obnovit');
define("_INSTALL_L210","Druhý krok instalace");
define('_INSTALL_CHARSET','WINDOWS-1250');
define('_INSTALL_LANG_XOOPS_SALT', "DOPLNÌNÍ");
define('_INSTALL_LANG_XOOPS_SALT_DESC', "Toto hraje doplòkovou roli pro generování tajných kódù a znakù. Výchozí hodnotu není tøeba mìnit.");
define('_INSTALL_HEADER_MESSAGE','Bìhem instalace pozornì ètìte a vyplòujte požadované údaje.');
?>
