...
class Legacy_Controller extends XCube_Controller
{
	...
	function _setupEnvironment()
	{
		...
		require_once XOOPS_LEGACY_PATH.'/kernel/object.php';				
		require_once XOOPS_LEGACY_PATH.'/kernel/handler.php';				
	...
	function _setupUser()
	{
		...
		$GLOBALS['xoopsUserIsAdmin'] = is_object($this->mRoot->mContext->mXoopsUser) ? $this->mRoot->mContext->mXoopsUser->isAdmin(1) : false;	
