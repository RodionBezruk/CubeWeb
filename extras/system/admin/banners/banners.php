...
function BannerDelete($bid)
{
    ...
    if ($htmlbanner){
        ...
        if(strtolower(substr($imageurl,strrpos($imageurl,".")))==".swf") {
            echo "<object classid=\"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000\" codebase=\"http:
            echo "<param name='movie' value='$imageurl'></param>";
            echo "<param name='quality' value='high'></param>";
            echo "<embed src='$imageurl' quality='high' pluginspage='http:
            echo "</embed>";
            echo "</object>";
        } else {
            ...
            $bannerobject = '<div><a href="'.$clickurl.'" target="_blank">';
                if(strtolower(substr($imageurl,strrpos($imageurl,".")))==".swf") {
                    $bannerobject = $bannerobject
                        ...
                        .'<embed src="'.$imageurl.'" quality="high" pluginspage="http:
                        .'</embed>'
                        .'</object>';
                } else {
